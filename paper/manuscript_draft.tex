...
All simulation data, analysis code, and visualization scripts are publicly available at \url{https://github.com/ProhunterPL/live2.0}. Raw simulation outputs are deposited at Zenodo (DOI: 10.5281/zenodo.17814793).
...
\begin{itemize}
    ...
    \item Figures S1-S9: Additional validation and analysis
\end{itemize}
