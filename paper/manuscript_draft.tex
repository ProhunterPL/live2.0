...
All simulation data, analysis code, and visualization scripts are publicly available at \url{https://github.com/ProhunterPL/live2.0}. Raw simulation outputs are deposited at Zenodo (DOI: [data DOI - to be assigned after deposit creation]).
