...
All simulation data, analysis code, and visualization scripts are publicly available at \url{https://github.com/ProhunterPL/live2.0} (DOI: [Zenodo DOI - to be assigned]). Raw simulation outputs are deposited at Zenodo (DOI: [data DOI - to be assigned]).
