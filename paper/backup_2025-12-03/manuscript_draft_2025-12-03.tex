...
Miller-Urey conditions produced 56.2 ± 8.6 species per run (mean ± SD across 18 replicates), significantly different from hydrothermal (59.5 ± 7.8, Kruskal-Wallis p < 0.001) and formamide (36.5 ± 4.5, p < 0.001) environments. The hydrothermal scenario exhibited the highest molecular diversity, consistent with its richer starting composition (Figure \ref{fig:diversity}A).
...
Quantitative network metrics confirmed scenario differences (Table S2). Network analysis revealed distinct hub molecules and connectivity patterns in each scenario, with scenario-specific molecules serving as key intermediates in reaction networks.
...
Autocatalytic cycle frequency showed trends but did not differ significantly across scenarios: Miller-Urey (20,555 ± 34,190 cycles/run), Hydrothermal (12,073 ± 23,699, Kruskal-Wallis p = 0.063), Formamide (24,260 ± 39,996, p = 0.063, Figure \ref{fig:autocatalysis}B). Miller-Urey exhibited the highest median cycle frequency, with some replicates containing >20,000 distinct autocatalytic pathways.
...
\begin{figure}[h]
    ...
    (A) Detection timeline. (B) Top novel molecules. (C) Formation pathways.
...
\input{tables/table5_hub_molecules.tex}

\input{tables/table6_novel_molecules.tex}
